from hashmap import HashMap as Map
...
class Transaction:
    ...
    def __init__(self, from_user, to_user, amount):
        ...
        who receives the money, and the amount of money
        """
    ...
    def __repr__(self):
        ...
        """
        return f"(Sender: {self.from_user}, Receiver: {self.to_user}, Amount: {self.amount} HuskyCoin)"
...
class Block:
    ...
    def _init_(self, transactions=None, previous_block=None):
        """
        Defines variables:
    ...
    def add_transaction(self, transaction):
        ...
        # transaction = Transaction(sender, receiver, money)
...
class Blockchain:
    ...
    _BLOCK_REWARD = 1000  # Among of HuskyCoin given as a reward for mining a block
